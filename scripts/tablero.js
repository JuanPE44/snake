class Game {
  ...
  chocarPared(idCabeza) {
    ...
    if (
      id1 > 0 &&
      id1 < this.tableroSize - 1 &&
      id0 > 0 &&
      id0 < this.tableroSize - 1
    ) {
      return false;
    } else {
      return true;
  ...
  control(e) {
    switch (e.keyCode) {
      case 39:
        this.direccion !== 3 ? (this.direccion = 1) : ""; // derecha
        break;
      case 38:
        this.direccion !== 4 ? (this.direccion = 2) : ""; // arriba
        break;
      case 37:
        this.direccion !== 1 ? (this.direccion = 3) : ""; // izquierda
        break;
      case 40:
        this.direccion !== 2 ? (this.direccion = 4) : ""; // abajo
    }
  }
}
